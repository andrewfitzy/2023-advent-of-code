...
import {solve, getNextNumber} from '../../src/day_09/solution_pt2';
...
describe('test solve', () => {
  ...
  testSkipsCi('puzzle input expects 1068', () => {
